# The given GUI appends here 
# All the instantaneous forces are appended in place of simulation_data
# Inputs: 
...
# Unpack values
Altitude, MRR, TRR, V, VW, MR_nb, TR_nb, MR_Taper_ratio, TR_Taper_ratio, MR_rc, TR_rc, MR_root_twist, MR_tip_twist, TR_root_twist, TR_tip_twist, MR_chord, TR_chord, HS_chord, MR_omega, MRA, Iterations = Input_Plugger()
...
simulator_inputs = U_Inputs_Simulator(Altitude, MRR, TRR, V, VW, MR_nb, TR_nb, MR_Taper_ratio, TR_Taper_ratio, 
                                      ...
                                      MR_chord, TR_chord, HS_chord, MR_omega, MRA, Iterations)
