...
from Mission_Planner import Hover_Climb, Forward_Flight
...
mission_inputs= U_Inputs_Planner(VW, Altitude, SFC, FW, Power_loss)
...
forward_flight  = Forward_Flight(simulator_inputs, mission_inputs, atmosphere, blade)
